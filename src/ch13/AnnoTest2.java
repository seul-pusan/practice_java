...
public class AnnoTest2 {
	...
	public static void test() {
		...
		try {
			...
			Method m = c.getMethod("test");		//test이름으로 선언된 메서드의 정보를 가진 Method 객체를 생성하여 반환
			annoList = m.getAnnotations();		//m이 참조하는 메서드에 정의된 어노테이션들을 Annotation 객체로 생성한 후 배열에 저장하여 반환
			System.out.println();
