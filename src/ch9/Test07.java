...
public class Test07 {
	public static void main(String[] args) {
		String s = "Korea, Japan, China, USA, Germany, France";

		String[] list1 = s.split(", ");
		String[] list2 = s.split(", ", 2);

		for (String item : list1) { // 배열 list1 안에 들어 있는 요소들을 하나씩 꺼내서 item 변수에 넣어주겠다
		...
		String email = "purum@ruby.co.kr";
		int i = email.indexOf("@");

		String id = email.substring(0, i);		//i-1까지 추출
